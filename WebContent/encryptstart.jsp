...
%>
		...
		<!-- Main -->
			<section id="main" class="container">
					...
					<div class="row"><div class="6u 6u(mobilep)">
							<h4>Enter target id </h4><input type="text"  name="target" value="" placeholder="target" required />
							<p></p>
						</div>
						<div class="6u 6u(mobilep)">
							<h4>Description of your file (70 characters)</h4><input type="text"  name="des" value="" placeholder="description" required />
							<p></p>
						</div></div>
			
					<br><div class="box">
					<center><h3><strong> Perform Encryption</strong> </h3></center>
					<center><input type="submit" class="button" value="Start"></center>
